...
The notes in this section describe how this repository is developed and governed by an agent workflow. They are not part of the product surface area.

This repo intentionally treats the codebase as the system of record:

- short `AGENTS.md`
- versioned plans and architecture notes under `docs/`
- generated artifacts committed or regenerated deterministically
- tests against small fixtures to keep agent output anchored

The workflow is inspired by OpenAI's Harness Engineering article:
